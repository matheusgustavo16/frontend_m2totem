          ...
          {downloadData.picture && (
            <>
              <button
                ...
                className="uppercase absolute flex gap-2 items-center text-white bg-[#D3303D] text-xl p-3 px-12 shadow-lg hover:shadow-xl bottom-12 border border-white rounded-lg transition duration-300 disabled:cursor-not-allowed disabled:bg-zinc-500 ease-in-out font-semibold hover:bg-red-500"
              >
                <Download />
                baixar foto
              </button>
        ...
        <div className="flex my-8 mb-4">
          {downloadData.picture && (
            <Link
              ...
              onClick={() => saveApiDownload(slug, id, JSON.stringify({}))}
              target="_blank"
              className="bg-[#D3303D] text-white font-[Gotham] font-bold tracking-tighter p-4 text-4xl uppercase px-12 disabled:cursor-not-allowed disabled:opacity-25 hover:scale-105"
            >
              baixar foto
            </Link>
          )}
