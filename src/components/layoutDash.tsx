...
export default function LayoutDash({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: 'Estações', href: '/dashboard/stations', current: path?.includes('/dashboard/stations') },
    { name: 'Campanhas', href: '/dashboard/campaigns', current: path?.includes('/dashboard/campaigns') },
    { name: 'Relatórios', href: '/dashboard/reports', current: path?.includes('/dashboard/reports') }
  ];
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="border-t border-indigo-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                      <div className="text-base font-medium text-white">Admin Totemfy</div>
                      <div className="text-sm font-medium text-indigo-300">{session?.data?.user?.email}</div>
                    </div>
                    <button
                      type="button"
